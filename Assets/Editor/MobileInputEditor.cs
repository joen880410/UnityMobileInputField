...
namespace UMI {
    ...
    public class MobileInputEditor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            _target.ReturnKey = (MobileInputField.ReturnKeyType)GUILayout.Toolbar((int)_target.ReturnKey, new string[] { MobileInputField.ReturnKeyType.Send.ToString(),
                                                                                                                         MobileInputField.ReturnKeyType.Next.ToString(),
                                                                                                                         MobileInputField.ReturnKeyType.Done.ToString(),
                                                                                                                         MobileInputField.ReturnKeyType.Search.ToString()});
            GUILayout.Space(OFFSET);
